...
Go to our [issue tracker](https://github.com/danog/TelegramFlooder/issues) and check if your problem/suggestion is already reported. If not, create a new issue with a descriptive title and detail your suggestion or steps to reproduce the problem.
...
```
$ git remote add upstream git@github.com:danog/TelegramFlooder.git
$ git fetch upstream
```
